...
import { Code, Layout, Cpu, Palette, Users, Award, Sparkles, Briefcase, Rocket, GitBranch } from 'lucide-react';
...
const skillsData = [
  {
    ...
    items: ['React.js', 'Next.js', 'JavaScript (ES6+)', 'TypeScript', 'Node.js'],
    icon: <Code size={20} />,
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        >
          <motion.div
            className="lg:col-span-2 bg-white dark:bg-slate-800/50 p-8 md:p-10 rounded-3xl shadow-xl border border-slate-100/70 dark:border-slate-700/50" 
          ...
          <div className="space-y-8">
            <motion.div
              className="bg-white dark:bg-slate-800/50 p-8 rounded-3xl shadow-xl border border-slate-100/70 dark:border-slate-700/50" 
              variants={itemVariants}
            >
